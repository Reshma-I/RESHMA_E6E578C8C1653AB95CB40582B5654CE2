...
Ensure that the account balance cannot be accesed directly from outside the class.
write a program to create an instance of the BankAccount class and test the deposit and withdrawl functionality.'''
...
def deposit(self, amount):
  if amount > 0:
    self.__account_blance += amount
    # self.__account = self.__account_balance+amount
